...
namespace DraCode.KoboldTown.Agents
{
    ...
    public static class KoboldTownAgentFactory
    {
        ...
        /// </summary>
        private static Agent.LLMs.Providers.ILlmProvider CreateLlmProvider(
            string provider,
            Dictionary<string, string> config)
        {
            ...
            return provider.ToLowerInvariant() switch
            {
                ...
                _ => throw new ArgumentException($"Unknown provider '{provider}'. Supported providers: openai, azureopenai, claude, gemini, ollama, githubcopilot")
            };
        }
    }
}
