...
// Copy Birko CSS files to wwwroot
console.log('📋 Copying Birko CSS files...');
copyFileSync('C:/Source/Birko.Web.Components/css/reset.css', 'wwwroot/css/reset.css');
copyFileSync('C:/Source/Birko.Web.Components/css/tokens.css', 'wwwroot/css/tokens.css');
console.log('✓ CSS files copied to wwwroot/css/');
...
// Generate content hash from built app.js
const appHash = createHash('md5')
  .update(readFileSync('wwwroot/js/main.js'))
  .digest('hex')
  .slice(0, 8);
