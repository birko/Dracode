...
export class ModalManager {
     ...
     */
    ensureModalExists() {
        this.modalElement = document.querySelector('#birko-modal');
        if (!this.modalElement) {
            // Create modal if it doesn't exist
            this.modalElement = document.createElement('b-modal');
        ...
        `;
            ...
            renderActions: (resolve, reject) => {
                ...
                connectButton.addEventListener('click', () => {
                    const tabName = document.querySelector('#connection-tab-name')?.value || '';
                    const workingDir = document.querySelector('#connection-working-dir')?.value || '';
                    if (!tabName.trim()) {
                ...
                setTimeout(() => {
                    const input = document.querySelector('#connection-tab-name');
                    input?.focus();
                }, 100);
                return footer;
            }
