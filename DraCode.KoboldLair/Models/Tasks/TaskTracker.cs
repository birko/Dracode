...
namespace DraCode.KoboldLair.Models.Tasks
{
    ...
    public class TaskTracker
    {
        ...
        /// <summary>
        /// Save the markdown report to a file (synchronous - prefer SaveToFileAsync)
        /// </summary>
        ...
        /// <summary>
        /// Loads tasks from a markdown file, restoring task state (synchronous - prefer LoadFromFileAsync).
